    ...
    <div className='calender-app'>
        ...
        <div className="days">
            ...
            }
            {
              [...Array(daysInMonth).keys()].map((day)=>(
                <span key={day+1} className={day+1 === currentDate.getDate()&& currentMonth === currentDate.getMonth()&& currentYear ===currentDate.getFullYear()?'current-date':''} onClick={()=> handleDayClick(day+1)}>{day +1}</span>
              ))
            }
        </div> 
      </div>
      ...
      <div className="events">
        {showEventPopup&&<div className="event-popup">
                ...
                <textarea placeholder='Enter Event Text (Max 60 characters)' value={eventText} onChange={(e)=>{
